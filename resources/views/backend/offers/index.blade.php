...
@section('content')
    <div class="container-fluid" style="margin-top:50px">
        ...
        <a href="{{ route('offers.create') }}" class="btn btn-primary mb-3 text-light " >Create New Offer &nbsp;<span class="fa fa-plus"></span></a>
        <a href="#" class="btn btn-primary mb-3 ml-3 text-light" disabled>Create Trip &nbsp;<span class="fa fa-plus"></span></a>
