    ...
    <div class="container-fluid" style="margin-top: 50px">
        ...
        <div class="form-check-inline mb-3">
            @foreach($activeLangs as $lang)
                ...
                @else
                    <label class="form-check-label mr-2"><input type="checkbox" class="form-check-input lang-check" value="{{$lang->id}}">{{$lang->name}}</label>
                @endif
            @endforeach
        </div>
...
@push('scripts')
    ...
    <script>
        $(document).ready(function(){
            ...
            $(document).on('change', '.lang-check', function(){
